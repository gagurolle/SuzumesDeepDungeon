...
public class DeepDungeon : ControllerBase
{
    ...
    {
        // Ѕазовый запрос с включением св€занных данных
        ...
        {
            // ѕриводим к нижнему регистру дл€ регистронезависимого поиска
        ...
        query = (sortBy?.ToLower(), desc) switch
        {
            ...
            _ => query.OrderByDescending(g => g.Created) // ѕо умолчанию
        };
    ...
    public async Task<ActionResult<GameRankDTO>> UpdateGameRank([FromBody] GameRankDTO updatedGameRank)
    {
        ...
        //магазины, ачивки , теги и трейлеры если пришли другие, отличные от существующих, то удал€ем старые и добавл€ем новые. Ќадо сравнить rawgId старое и новое, если они не совпадают, то удал€ем старые сущности тегов, трейлеров ачивок и магазинов, и добавл€ем новые.
